                    ...
                    <table class="table table-hover align-middle">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th scope="col" @click="handleSort('quantityOnHand')" class="sortable">
                                    Tồn kho
                                    <i :class="getSortIcon('quantityOnHand')"></i>
                                </th>
                        ...
                        <tbody>
                            <tr v-for="ingredient in data.content" :key="ingredient.id">
                                ...
                                <td>
                                    <span class="badge"
                                        :class="ingredient.quantityOnHand <= ingredient.reorderLevel ? 'bg-danger-muted' : 'bg-light text-dark'">
...
const openAdjustModal = (ingredient) => {
    ...
    adjustData.currentStock = ingredient.quantityOnHand
