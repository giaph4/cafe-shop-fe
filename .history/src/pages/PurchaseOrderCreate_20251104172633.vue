                                    ...
                                    <tbody>
                                        <FieldArray name="items" v-slot="{ fields, push, remove }">
                                            <tr v-for="(field, idx) in fields" :key="field.key">
                                                <td>
                                                    <Field :name="`purchaseOrderDetails[${idx}].ingredientId`" as="select"
                                                        class="form-select"
                                                        :class="{ 'is-invalid': errors[`items[${idx}].ingredientName`] }">
...
import { getAllIngredients } from '@/api/ingredientService' // Import hàm đã sửa
