          ...
          <div class="modal-header">
            <div class="modal-header__content">
              <h5 class="modal-title">
                Chi tiết nhân viên: <strong>{{ staff.fullName }}</strong>
              </h5>
              <p class="modal-subtitle mb-0">
                Xem thông tin chi tiết và phân tích hiệu suất
              </p>
            </div>
            <button
              type="button"
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <span
                              ...
                              :class="getScoreBadgeClass(staff.metrics.revenue, staff.metrics.teamAvgRevenue)"
                            >
                        ...
                        <tr>
                          ...
                          <td>
                            <span
                              class="badge badge-soft"
                              :class="getScoreBadgeClass(staff.metrics.ordersCount, staff.metrics.teamAvgOrders)"
                            >
                        ...
                        <tr>
                          ...
                          <td>
                            <span
                              class="badge badge-soft"
                              :class="getAttendanceBadgeClass(staff.metrics.attendanceRate)"
                            >
                        ...
                        <tr>
                          ...
                          <td>
                            <span
                              class="badge badge-soft"
                              :class="getOnTimeBadgeClass(staff.metrics.onTimeRate)"
                            >
