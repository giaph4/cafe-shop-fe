<template>
  ...
  // Prop để điều khiển trạng thái thu gọn (sẽ được truyền từ MainLayout)
  defineProps({
    isCollapsed: Boolean
  })
  
  const handleLogout = () => {
    // Chúng ta sẽ thêm logic đăng xuất (Pinia) ở đây
    alert('Đăng xuất!')
  }
  </script>
  
  <style scoped>
  /* Style sẽ được thêm vào main.scss để dễ quản lý */
  </style>