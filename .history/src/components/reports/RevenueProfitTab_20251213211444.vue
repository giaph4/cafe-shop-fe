...
// Format ngày ngắn gọn (06 hoặc 06/12) - chỉ hiển thị ngày hoặc ngày/tháng, không có năm
const formatDateShort = (dateString) => {
    ...
    try {
        ...
        // Nếu đang xem cùng tháng, chỉ hiển thị ngày (06, 07)
        // Nếu khác tháng, hiển thị ngày/tháng (06/12)
        // Ưu tiên chỉ hiển thị ngày để gọn nhất
        return day
    } catch {
