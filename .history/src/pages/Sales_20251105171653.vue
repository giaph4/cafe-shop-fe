            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-footer d-flex flex-wrap gap-2">
                        ...
                        <button class="btn btn-outline-danger" :disabled="!activeOrder" @click="cancelCurrentOrder">Hủy đơn</button>
                        <div class="ms-auto d-flex gap-2">
                            ...
                            <button class="btn btn-primary" @click="createOrSubmitOrder">{{ activeOrder ? 'Gửi bếp' : 'Tạo đơn' }}</button>
                            <button class="btn btn-success" :disabled="!activeOrder" @click="payCurrentOrder">Thanh toán</button>
                        </div>
                    </div>
                </div>
            </div>
