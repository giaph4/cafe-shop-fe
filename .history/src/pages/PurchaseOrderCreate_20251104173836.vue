                    ...
                    <tbody>
                      <FieldArray name="items" v-slot="{ fields, push, remove }">
                        <tr v-for="(field, idx) in fields" :key="field.key">
                          <td>
                            ...
                            >
                              ...
                              <option v-for="ing in ingredients?.value || []" :key="ing.id" :value="ing.id">
                                {{ ing.name }} ({{ ing.unit }})
                              </option>
                            </Field>
                        ...
                        <tr v-if="fields.length === 0">
                          <td colspan="5" class="text-center text-muted">Chưa có mặt hàng nào.</td>
                        </tr>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="mb-3">
                  ...
                  <Field name="supplierId" as="select" class="form-select" :class="{ 'is-invalid': errors.supplierId }">
