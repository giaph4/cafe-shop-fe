<template>
  <Teleport to="body">
    <div
      ref="modal"
      class="modal fade shift-template-form-modal"
      tabindex="-1"
      aria-hidden="true"
    >
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">
              {{ props.template ? 'Cập nhật ca mẫu' : 'Tạo ca mẫu mới' }}
            </h5>
            <button
              type="button"
              class="btn-close"
          ...
          <div class="modal-body">
            ...
            >
              ...
              <div class="col-md-6">
                ...
                <div
                  class="roles-input form-control"
                  @click="focusRoleInput"
                >
                  <span
                  ...
                  <input
                    ...
                    @keydown.comma.prevent="appendRole"
                    @blur="appendRole"
                  >
                </div>
              </div>
              <div class="col-12">
                ...
                <textarea
                  ...
                  rows="2"
                  maxlength="1000"
                  placeholder="Giới thiệu ngắn về ca làm"
                />
              </div>
              ...
              <div class="col-md-3 col-sm-6">
                ...
                <input
                  v-model.number="form.defaultHourlyRate"
                  type="number"
                  class="form-control"
                  min="0"
                  step="1000"
              ...
              <div class="col-md-3 col-sm-6">
                ...
                <input
                  v-model.number="form.defaultFixedAllowance"
                  type="number"
                  class="form-control"
                  min="0"
                  step="1000"
...
const hydrateForm = (template) => {
    ...
    form.roles = Array.isArray(template.requiredRoles)
