                ...
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <table class="table align-middle">
                                    ...
                                    <tbody>
                                        <FieldArray name="items" v-slot="{ fields, remove }">
                                            <!-- 'push' đã được lấy từ script setup -->
                            ...
                            <!-- 
                  FIX LỖI:
                  Nút này bây giờ có thể gọi hàm 'push' 
                  vì 'push' đã được định nghĩa trong <script setup>
                -->
...
// === FIX LỖI "push is not a function" ===
// Lấy hàm push và remove từ useFieldArray để dùng trong toàn bộ <template>
