<template>
    <div class="trend-analysis-page page-container container-fluid" data-aos="fade-up">
        <PageHeader
            ...
            <div class="card-body">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-lg-2 col-md-6">
                        ...
                        <select class="form-select clean-input" v-model="filters.metric">
        ...
        <LoadingState v-if="loading" text="Đang phân tích xu hướng..." />
        <ErrorState
            v-else-if="error"
            :message="error"
            @retry="handleAnalyze"
        ...
        <div v-else-if="hasData" class="analysis-content">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="kpi-card kpi-card--primary">
                        ...
                        <div class="kpi-card__content">
                            <div class="kpi-card__label">Tăng trưởng Tuần</div>
                            <div class="kpi-card__value" :class="growthMetrics?.wow >= 0 ? 'text-success' : 'text-danger'">
                                {{ growthMetrics?.wow >= 0 ? '+' : '' }}{{ (growthMetrics?.wow || 0).toFixed(1) }}%
                            </div>
                            <div class="kpi-card__subtitle">Week-over-week</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="kpi-card kpi-card--info">
                        ...
                        <div class="kpi-card__content">
                            <div class="kpi-card__label">Tăng trưởng Tháng</div>
                            <div class="kpi-card__value" :class="growthMetrics?.mom >= 0 ? 'text-success' : 'text-danger'">
                                {{ growthMetrics?.mom >= 0 ? '+' : '' }}{{ (growthMetrics?.mom || 0).toFixed(1) }}%
                            </div>
                            <div class="kpi-card__subtitle">Month-over-month</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="kpi-card kpi-card--success">
                        ...
                        <div class="kpi-card__content">
                            ...
                            <div class="kpi-card__subtitle">{{ summary?.totalDays || 0 }} ngày</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="kpi-card kpi-card--warning">
                        ...
                        <div class="kpi-card__content">
                            ...
                            <div class="kpi-card__value">{{ formatNumber(summary?.totalOrders || 0) }}</div>
            ...
            <div v-if="anomalies.length > 0" class="alerts-section mb-4">
                <div class="alert alert-warning">
                    <div class="d-flex align-items-center gap-3">
                        <i class="bi bi-exclamation-triangle-fill alert-icon"></i>
                        <div class="flex-grow-1">
                            <div class="alert-title">Phát hiện {{ anomalies.length }} bất thường</div>
                            <div class="alert-message">Có những ngày có doanh thu bất thường so với trung bình</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="card standard-card">
                        <div class="card-header standard-card-header">
                            <h5 class="card-title">Xu hướng theo thời gian</h5>
                        </div>
                        <div class="card-body">
                            <TrendChart :daily-data="dailyData" :anomalies="anomalies" />
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card standard-card">
                        <div class="card-header standard-card-header">
                            <h5 class="card-title">Pattern theo tuần</h5>
                        </div>
                        <div class="card-body">
            ...
            <div class="row g-4 mb-4">
                <div class="col-lg-6">
                    <div class="card standard-card">
                        <div class="card-header standard-card-header">
                            <h5 class="card-title">Pattern theo tháng</h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-6">
                    <div class="card standard-card">
                        <div class="card-header standard-card-header">
                            <h5 class="card-title">Xu hướng theo danh mục</h5>
                        </div>
                        <div class="card-body">
