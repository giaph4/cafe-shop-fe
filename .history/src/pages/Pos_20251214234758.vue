...
const isTakeawaySectionCollapsed = ref(true) // Mặc định thu gọn section đơn mang về để tiết kiệm không gian
const isDraftSectionCollapsed = ref(true) // Mặc định thu gọn section đơn nháp để tiết kiệm không gian
