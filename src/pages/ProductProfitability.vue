<template>
    <div class="product-profitability-page page-container container-fluid" data-aos="fade-up">
        <PageHeader
            ...
            <div class="card-body">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-lg-2 col-md-6">
                        ...
                        <select class="form-select clean-input" v-model="filters.categoryId">
                    ...
                    <div class="col-lg-2 col-md-6">
                        ...
                        <select class="form-select clean-input" v-model="filters.classification">
                            <option value="">Tất cả</option>
        ...
        <LoadingState v-if="loading" text="Đang phân tích lợi nhuận sản phẩm..." />
        <ErrorState
            v-else-if="error"
            :message="error"
            @retry="handleAnalyze"
        ...
        <div v-else-if="hasData" class="analytics-content">
            <div class="row g-4 mb-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="kpi-card kpi-card--info">
                        ...
                        <div class="kpi-card__content">
                            <div class="kpi-card__label">Margin trung bình</div>
            ...
            <div class="row g-4 mb-4">
                <div class="col-lg-8">
                    <div class="card standard-card">
                        <div class="card-header standard-card-header">
                            <h5 class="card-title">Profitability Matrix</h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-4">
                    <div class="card standard-card">
                        <div class="card-header standard-card-header">
                            <h5 class="card-title">So sánh theo Danh mục</h5>
                        </div>
                        <div class="card-body">
            ...
            <div class="row g-4 mb-4">
                <div class="col-lg-6">
                    <div class="card standard-card">
                        <div class="card-header standard-card-header">
                            <h5 class="card-title">Top 10 sản phẩm lợi nhuận cao</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-minimal">
                                    ...
                                    <tbody>
                                        <tr v-for="product in topProfitable" :key="product.productId">
                                            <td>
                                                <div class="fw-semibold product-name">{{ product.name }}</div>
                                                <small class="text-muted">{{ product.categoryName }}</small>
                                            </td>
                                            <td class="profit-cell">{{ formatCurrency(product.profit) }}</td>
                                            <td>
                ...
                <div class="col-lg-6">
                    <div class="card standard-card">
                        <div class="card-header standard-card-header">
                            <h5 class="card-title">Sản phẩm cần chú ý (Margin thấp)</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-minimal">
                                    ...
                                    <tbody>
                                        <tr v-for="product in lowMargin" :key="product.productId">
                                            <td>
                                                <div class="fw-semibold product-name">{{ product.name }}</div>
                                                <small class="text-muted">{{ product.categoryName }}</small>
                                            </td>
