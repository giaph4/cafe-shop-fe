          ...
          <div class="filter-grid">
            ...
            <div class="filter-item">
              ...
              <input
                ...
                title="Chọn ngày và giờ bắt đầu hiệu lực"
              >
            </div>
            <div class="filter-item">
              ...
              <input
                ...
                type="datetime-local"
                class="form-control date-time-input"
                title="Chọn ngày và giờ kết thúc hiệu lực"
              >
            </div>
          ...
          <table class="table align-middle">
            ...
            <tbody>
              ...
              >
                ...
                <td class="voucher-description">
                  <span class="voucher-description-text">{{ voucher.description }}</span>
                </td>
                <td>
                  <span
...
/* Date Time Input - Ẩn placeholder kỹ thuật */
...
.date-time-input::-webkit-datetime-edit-hour-field,
.date-time-input::-webkit-datetime-edit-minute-field,
.date-time-input::-webkit-datetime-edit-second-field,
.date-time-input::-webkit-datetime-edit-ampm-field {
    color: var(--color-heading);
}

.date-time-input:invalid::-webkit-datetime-edit {
    color: var(--color-text-muted);
}
...
/* Voucher Description - Truncate để tránh vỡ layout */
.voucher-description {
    max-width: 300px;
}
...
/* Đảm bảo các cột số liệu căn phải */
.table-card td.text-end {
    text-align: right !important;
}

.table-card th.text-end {
    text-align: right !important;
}
