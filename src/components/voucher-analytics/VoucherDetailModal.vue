                ...
                <div class="modal-content" @click.stop>
                    <div class="modal-header">
                        <div class="modal-header__content">
                            <h5 class="modal-title">Chi tiết Voucher: <strong>{{ voucher.code }}</strong></h5>
                            <p class="modal-subtitle mb-0">Xem thông tin chi tiết và phân tích hiệu quả của voucher</p>
                        </div>
                        <button
                            type="button"
                            class="btn-close"
                ...
                <div class="modal-body">
                                        ...
                                        <div class="col-6">
                                            <div class="stat-box">
                                                ...
                                                <div class="stat-content">
                                                    ...
                                                    <div class="stat-value">{{ formatNumber(voucher.metrics.totalUsage) }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="stat-box">
                                                ...
                                                <div class="stat-content">
                                                    ...
                                                    <div class="stat-value">{{ formatCurrency(voucher.metrics.totalDiscount) }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="stat-box">
                                                ...
                                                <div class="stat-content">
                                                    ...
                                                    <div class="stat-value">{{ formatCurrency(voucher.metrics.totalRevenue) }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="stat-box">
                                                <div class="stat-icon" :class="voucher.metrics.roi >= 0 ? 'stat-icon--success' : 'stat-icon--danger'">
                                                    <i class="bi bi-graph-up-arrow"></i>
                                                </div>
                                                <div class="stat-content">
                                                    <div class="stat-label">ROI</div>
                                                    <div class="stat-value">{{ voucher.metrics.roi.toFixed(2) }}%</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="stat-box">
                                                ...
                                                <div class="stat-content">
                                                    ...
                                                    <div class="stat-value">{{ formatNumber(voucher.metrics.uniqueCustomers) }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="stat-box">
                                                ...
                                                <div class="stat-content">
                                                    ...
                                                    <div class="stat-value">{{ formatCurrency(voucher.metrics.avgOrderValue) }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="info-section mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <div class="info-card">
                                    <p class="label">Doanh thu tăng thêm</p>
                            ...
                            <div class="col-md-4">
                                <div class="info-card">
                                    <p class="label">Chi phí mỗi khách hàng</p>
                            ...
                            <div class="col-md-4">
                                <div class="info-card">
                                    <p class="label">So sánh doanh thu</p>
                                    <div class="value">
                                        <div class="mb-1">
                    ...
                    <div v-if="voucher.orders && voucher.orders.length > 0" class="info-section">
                        <h6 class="section-title mb-3">
                        ...
                        <div class="table-wrapper">
                            <div class="table-responsive" style="max-height: 300px;">
                                <table class="table table-minimal">
                                    ...
                                    <tbody>
                                        <tr v-for="order in voucher.orders.slice(0, 20)" :key="order.id">
                                            <td>{{ formatDateTime(order.date) }}</td>
                                            <td class="text-end">{{ formatCurrency(order.amount) }}</td>
                                            <td class="text-end fw-semibold discount-cell">{{ formatCurrency(order.discount) }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            <div v-if="voucher.orders.length > 20" class="text-center text-muted p-2">
