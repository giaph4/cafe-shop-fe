<template>
  <div class="admin-dashboard-tab">
        ...
        <div class="kpi-card kpi-card--revenue">
          ...
          <div class="kpi-card__content">
            ...
            <div class="kpi-card__detail">
              Lợi nhuận: {{ formatCurrency(dashboardData.revenue.todayProfit || 0) }}
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div class="kpi-card kpi-card--month">
          ...
          <div class="kpi-card__content">
            ...
            <div class="kpi-card__detail">
              Lợi nhuận: {{ formatCurrency(dashboardData.revenue.monthProfit || 0) }}
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div class="kpi-card kpi-card--orders">
          ...
          <div class="kpi-card__content">
            ...
            <div class="kpi-card__detail">
              Đã hủy: {{ formatNumber(dashboardData.orders.cancelledToday || 0) }}
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div class="kpi-card kpi-card--inventory">
          ...
          <div class="kpi-card__content">
            ...
            <div class="kpi-card__detail">
              Đơn nhập chờ: {{ formatNumber(dashboardData.inventory.pendingPurchaseOrders || 0) }}
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- System Alerts -->
    <div
      v-if="dashboardData?.alerts?.length > 0"
      class="card mb-4"
    >
      ...
      <div class="card-body">
        <div class="alert-list">
          ...
          >
            <i
              :class="getAlertIcon(alert.severity)"
    ...
    <div class="row g-4">
            ...
            <div class="top-list">
              ...
              >
                <div class="top-list-item__content">
                  <div class="top-list-item__name">
                    {{ product.productName || 'N/A' }}
                  </div>
                  <div class="top-list-item__detail">
      ...
      <!-- Top Customers -->
      <div
        v-if="dashboardData?.topCustomers?.length > 0"
        class="col-lg-4"
      >
        <div class="card info-card">
          <div class="card-header">
            ...
            <div class="top-list">
              ...
              >
                <div class="top-list-item__content">
                  ...
                  <div class="top-list-item__detail">
                    {{ formatNumber(customer.orders) }} đơn
                  </div>
                </div>
                <div class="top-list-item__value">
      ...
      <!-- Top Staff -->
      <div
        v-if="dashboardData?.topStaff?.length > 0"
        class="col-lg-4"
      >
        <div class="card info-card">
          <div class="card-header">
