...
/* Outline button style cho nút Tạo đơn */
...
.status-warning {
    border-color: #f59e0b;
    background: linear-gradient(to bottom, rgba(245, 158, 11, 0.05) 0%, var(--color-card) 100%);
}
...
.status-warning:hover {
    border-color: #d97706;
    background: linear-gradient(to bottom, rgba(245, 158, 11, 0.1) 0%, var(--color-card-muted) 100%);
}
...
.status-info {
    border-color: #0ea5e9;
    background: linear-gradient(to bottom, rgba(14, 165, 233, 0.05) 0%, var(--color-card) 100%);
}
...
.status-info:hover {
    border-color: #0284c7;
    background: linear-gradient(to bottom, rgba(14, 165, 233, 0.1) 0%, var(--color-card-muted) 100%);
}
