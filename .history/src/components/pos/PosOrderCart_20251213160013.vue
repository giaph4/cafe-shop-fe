      ...
      >
        ...
        >
          ...
          <div class="pos-cart__item-actions">
            ...
            <button
              class="btn btn-outline-danger pos-cart__delete-btn"
              type="button"
              :disabled="isProcessing('quantity')"
              aria-label="Xóa món"
...
const handlePaymentResultViewDetail = () => {
    ...
    // Đóng payment result modal
    paymentResultModalRef.value?.hide()

    // Đợi modal đóng hoàn toàn rồi mới mở order detail modal
    setTimeout(() => {
    ...
    // Reset payment result state sau khi đã mở order detail
    setTimeout(() => {
        paymentResult.value = null
        paymentResultOrderInfo.value = null
        paymentErrorMessage.value = null
...
const handlePaymentResultRetry = () => {
    // Thử lại thanh toán
    paymentResult.value = null
    paymentResultOrderInfo.value = null
    paymentErrorMessage.value = null
