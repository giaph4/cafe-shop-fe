...
/**
 * Lấy assignments với filters (admin/manager only)
 * @param {Object} params - Query parameters
 * @param {number} params.userId - ID của user (optional)
 * @param {string} params.startDate - Ngày bắt đầu (ISO format yyyy-MM-dd, optional)
 * @param {string} params.endDate - Ngày kết thúc (ISO format yyyy-MM-dd, optional)
 ...
 * @returns {Promise<Object>} Paginated response với assignments
 */
...
/**
 * Lấy tất cả assignments với filters (admin/manager only)
 * @param {Object} params - Query parameters
 * @param {number} params.userId - ID của user (optional)
 * @param {string} params.startDate - Ngày bắt đầu (ISO format yyyy-MM-dd, optional)
 * @param {string} params.endDate - Ngày kết thúc (ISO format yyyy-MM-dd, optional)
