          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="mb-2">
                    <strong class="d-block mb-1">Tên bàn:</strong>
                    <span>{{ deleteTarget?.name || '—' }}</span>
                  </div>
                  <div class="mb-0">
                    <strong class="d-block mb-1">Sức chứa:</strong>
              ...
              >
                ...
                >
                  <header class="table-card__header">
                    ...
                    <button
                      v-if="canManage"
                      class="btn btn-icon btn-icon--subtle btn-icon--card-edit"
                      type="button"
                      title="Chỉnh sửa"
                      @click="openModal(table)"
                    >
...
const getStatusVariant = (status) => {
    ...
    // Mặc định là success (xanh lá nhạt) cho bàn trống
...
/* Table Capacity Info - Không dùng badge, chỉ hiển thị icon + số */
.table-capacity-info {
    display: inline-flex;
    align-items: center;
    gap: var(--spacing-2);
...
.table-capacity-info i {
    font-size: 18px;
    color: var(--color-text-muted);
}

.table-capacity-info span {
    color: var(--color-heading);
    font-weight: var(--font-weight-medium);
}
