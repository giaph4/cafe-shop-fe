                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <Field name="fullName" type="text" class="form-control"
                                :class="{ 'is-invalid': errors.fullName }" id="fullName"
                                placeholder="Nguyễn Văn A" v-model="formData.fullName" />
                        ...
                        <div class="mb-3">
                            ...
                            <Field name="phone" type="text" class="form-control"
                                ...
                                placeholder="0901234567" v-model="formData.phone" />
                        ...
                        <div class="mb-3">
                            ...
                            <Field name="email" type="email" class="form-control"
                                ...
                                placeholder="example@email.com" v-model="formData.email" />
            ...
            <div class="card-body">
                <div class="input-group" style="max-width: 400px;">
                    ...
                    <input type="text" class="form-control"
                        placeholder="Tìm theo Tên đăng nhập, Họ tên, SĐT, Email..." v-model="searchQuery">
                </div>
            </div>
        </div>
                            ...
                            <tr v-for="user in filteredUsers" :key="user.id">
                                ...
                                <td>
                                    <span v-for="role in user.roles" :key="role.id" 
                                        class="badge me-1" :class="getRoleClass(role.name)">
                                        {{ role.name }}
                                    </span>
                                </td>
                                <td>
...
const isEditing = ref(false) // Chỉ dùng modal để Sửa
...
// --- State và Query cho danh sách Quyền (Roles) ---
const allRoles = ref([])
// Sửa lại useQuery theo code bạn cung cấp
...
// Hàm mới để xử lý check/uncheck role
...
const openModal = (user) => {
    ...
    formData.email = user.email || '' // Đảm bảo không phải null
...
const closeModal = () => {
    bsModal.value?.hide()
    // Không cần reset form vì chúng ta luôn fill data khi mở
}

// Xử lý Submit Form
const handleSubmit = (values) => {
    // 'values' từ VeeValidate đã chứa (fullName, phone, email, status, roleIds)
    // Gửi đúng DTO mà backend cần
...
const getRoleClass = (roleName) => {
    // Backend DTO trả về "ROLE_ADMIN", "ROLE_STAFF"
    if (roleName === 'ROLE_ADMIN') return 'bg-primary'
    if (roleName === 'ROLE_MANAGER') return 'bg-info text-dark'
