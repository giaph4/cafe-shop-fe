<template>
  <Teleport to="body">
    <div
      ref="modal"
      class="modal fade shift-template-detail-modal"
      tabindex="-1"
      aria-hidden="true"
    >
        ...
        <div class="modal-content">
          ...
          <div class="modal-body modal-body-scroll">
            ...
            >
              ...
              <div
                v-if="template.defaultHourlyRate || template.defaultFixedAllowance"
                class="info-section"
              >
                <h6 class="section-title">
                  Lương và Phụ cấp
                ...
                <div class="info-grid">
                  <div
                    v-if="template.defaultHourlyRate"
                    class="info-item"
                  >
                  ...
                  <div
                    v-if="template.defaultFixedAllowance"
                    class="info-item"
                  >
