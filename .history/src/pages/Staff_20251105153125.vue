    ...
    <div class="modal fade" id="staffModal" tabindex="-1" ref="modalElement" aria-labelledby="staffModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <Form @submit="handleSubmit" :validation-schema="staffSchema" v-slot="{ errors, values }">
...
const formData = reactive({
    ...
    email: '',
    status: 'ACTIVE',
    roleIds: [] // Dùng để lưu mảng ID các quyền [1, 2]
})

// --- State cho danh sách Quyền (Roles) ---
const allRoles = ref([])
const { data: rolesData, isLoading: allRolesLoading } = useQuery({
    ...
    staleTime: 1000 * 60 * 5 // Cache danh sách quyền trong 5 phút
})
...
const handleSubmit = (values) => {
    // 'values' đã chứa đúng định dạng UserUpdateRequestDTO
    // { fullName, phone, email, status, roleIds }
