                ...
                <div class="modal-content" @click.stop>
                    <div class="modal-header">
                        <div class="modal-header__content">
                            <h5 class="modal-title">Chi tiết đơn hủy: <strong>#{{ order.id || order.orderId || 'N/A' }}</strong></h5>
                            <p class="modal-subtitle mb-0">Thông tin chi tiết về đơn hàng đã hủy</p>
                        </div>
                        <button
                            type="button"
                            class="btn-close"
                    ...
                    <div class="modal-body">
                                ...
                                <div class="info-section">
                                    ...
                                    <div class="stat-box stat-box--danger">
                                        ...
                                        <div class="stat-content">
                                            ...
                                            <div class="stat-value">{{ formatCurrency(order.totalAmount || 0) }}</div>
                                            <div class="stat-subtitle">Doanh thu mất</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row g-4 mb-4" v-if="order.cancellationReason || order.reason">
                            <div class="col-12">
                                <div class="info-section">
                                    <h6 class="section-title mb-3">
                        ...
                        <div class="row g-4" v-if="order.items && order.items.length > 0">
                            <div class="col-12">
                                <div class="info-section">
                                    <h6 class="section-title mb-3">
                                        ...
                                        <table class="table table-minimal">
                                            ...
                                            <tbody>
                                                <tr v-for="(item, index) in order.items" :key="index">
                                                    ...
                                                    <td class="revenue-lost">{{ formatCurrency(item.totalPrice || (item.quantity * (item.unitPrice || item.price || 0))) }}</td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    <td colspan="3" class="text-end fw-semibold">Tổng cộng:</td>
                                                    <td class="revenue-lost fw-semibold">{{ formatCurrency(order.totalAmount || 0) }}</td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
