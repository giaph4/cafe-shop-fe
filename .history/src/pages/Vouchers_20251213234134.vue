          ...
          <table class="table align-middle">
            ...
            <tbody>
              ...
              >
                ...
                <td>
                  <div class="voucher-validity">
                    <div class="voucher-validity-item">
                      ...
                      <span class="voucher-validity-value">{{ formatDateTimeCompact(voucher.validFrom) }}</span>
                    </div>
                    <div class="voucher-validity-item">
                      <span class="voucher-validity-label">Đến:</span>
                      <span class="voucher-validity-value">{{ formatDateTimeCompact(voucher.validTo) }}</span>
                    </div>
                  </div>
                </td>
                ...
                <td>{{ formatDateTimeCompact(voucher.updatedAt || voucher.createdAt) }}</td>
...
// Format ngày tháng gọn gàng cho bảng
