<template>
          ...
          <div class="row g-3">
            <div class="col-md-3">
              ...
              <input
                ...
                id="search"
                class="form-control"
                placeholder="Nhập mã phiếu, tên NCC..."
                ...
                <tr v-for="order in purchaseOrders" :key="order.id">
                  ...
                  <td class="text-center">
                    ...
                    <template v-if="order.status === 'PENDING'">
                      <button class="btn btn-sm btn-success me-1" @click="handleChangeStatus(order.id, 'COMPLETED')">
                        <i class="fas fa-check"></i> Hoàn thành
                      </button>
                      <button class="btn btn-sm btn-warning me-1" @click="handleChangeStatus(order.id, 'CANCELLED')">
  ...
  .data-table-card .card-body {
    padding: 0; /* Xóa padding để table vừa khít */
  }
  .table {
    margin-bottom: 0; /* Xóa margin-bottom mặc định của table */
  }
