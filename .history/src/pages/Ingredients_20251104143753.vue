            ...
            <div class="modal-content">
                ...
                <Form @submit="handleAdjustSubmit" :validation-schema="adjustSchema" v-slot="{ errors }">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold">Số lượng tồn MỚI <span
                            ...
                            <tr v-for="ingredient in data.content" :key="ingredient.id">
                                ...
                                <td>
                                    <span class="badge"
                                        ...
                                        <!-- FIX LỖI TỒN KHO TRỐNG: Dùng 'quantityInStock' thay vì 'quantityOnHand' -->
...
// FIX LỖI 400: Sửa validation schema cho đúng DTO mới
...
const { data, isLoading, isError, error } = useQuery({
    // Thêm sortState vào queryKey để tự động gọi lại API khi sắp xếp
...
// FIX LỖI 400: Cập nhật logic mở modal
const openAdjustModal = (ingredient) => {
    adjustData.ingredientId = ingredient.id
    adjustData.name = ingredient.name
    adjustData.currentStock = ingredient.quantityInStock // FIX: Dùng quantityInStock
...
// FIX LỖI 400: Hàm submit này gửi đúng DTO
...
const handleSort = (key) => {
    ...
    currentPage.value = 1 // Reset về trang 1 khi sắp xếp
}
