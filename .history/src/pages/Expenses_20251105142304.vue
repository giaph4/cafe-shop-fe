                    ...
                    <table class="table table-hover align-middle">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th scope="col" @click="setSort('user.username')" class="sortable"> Người tạo <i
                                        :class="getSortIcon('user.username')"></i>
                                </th>
...
// === SỬA LỖI: Gộp tất cả state lọc/sort/page vào một object ===
...
}, { deep: true }) // <--- Thêm deep: true cho computed object
...
// Sắp xếp (Sửa lại để dùng filters)
const setSort = (field) => {
...
// Lấy icon cho cột sort (Sửa lại để dùng filters)
...
// === SỬA LỖI: Thêm hàm xử lý sự kiện phân trang ===
const onPageChange = (page) => {
    filters.page = page
}

// Reset về trang 1 khi lọc hoặc sort (Sửa lại watch)
